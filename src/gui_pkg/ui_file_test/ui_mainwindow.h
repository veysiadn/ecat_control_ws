...
public:
    ...
    QSpinBox *spn_target_val_[NUM_OF_SERVO_DRIVERS];
    MyButton *b_send[NUM_OF_SERVO_DRIVERS];

    MyButton *b_stop[NUM_OF_SERVO_DRIVERS];
    MyButton *b_enable[NUM_OF_SERVO_DRIVERS];
    MyButton *b_disable[NUM_OF_SERVO_DRIVERS];
    MyButton *b_vel[NUM_OF_SERVO_DRIVERS];
    MyButton *b_cyclic_vel[NUM_OF_SERVO_DRIVERS];
    MyButton *b_pos[NUM_OF_SERVO_DRIVERS];
    MyButton *b_cyclic_pos[NUM_OF_SERVO_DRIVERS];
    MyButton *b_tor[NUM_OF_SERVO_DRIVERS];
    MyButton *b_cyclic_tor[NUM_OF_SERVO_DRIVERS];
    ...
    QLabel *lb_target_pos[NUM_OF_SERVO_DRIVERS];
    QLabel *lb_actual_pos[NUM_OF_SERVO_DRIVERS];
    QLabel *lb_status_word[NUM_OF_SERVO_DRIVERS];
    QLabel *lb_control_word[NUM_OF_SERVO_DRIVERS];
    QLabel *lb_actual_vel[NUM_OF_SERVO_DRIVERS];
    QLabel *lb_target_vel[NUM_OF_SERVO_DRIVERS];
    QLabel *lb_actual_tor[NUM_OF_SERVO_DRIVERS];
    QLabel *lb_target_tor[NUM_OF_SERVO_DRIVERS];
    QLabel *lb_op_mode[NUM_OF_SERVO_DRIVERS];
    QLabel *label_motor[NUM_OF_SERVO_DRIVERS];
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        b_enable_vel->setStyleSheet(QString::fromUtf8("MyButton:pressed {\n"
        ...
        b_enable_cylic_vel->setStyleSheet(QString::fromUtf8("MyButton:pressed {\n"
                                                            "    background-color: rgb(5, 153, 44);\n"
                                                            "}\n"
                                                            "MyButton { \n"
                                                            "color: rgb(255, 255, 255);\n"
        ...
        b_enable_pos->setStyleSheet(QString::fromUtf8("MyButton:pressed {\n"
                                                      "    background-color: rgb(5, 153, 44);\n"
                                                      "}\n"
                                                      "MyButton { \n"
                                                      "color: rgb(255, 255, 255);\n"
        ...
        b_enable_cyclic_pos->setStyleSheet(QString::fromUtf8("MyButton:pressed {\n"
                                                             "    background-color: rgb(5, 153, 44);\n"
                                                             "}\n"
                                                             "MyButton { \n"
                                                             "color: rgb(255, 255, 255);\n"
        ...
        b_enable_torque->setStyleSheet(QString::fromUtf8("MyButton:pressed {\n"
                                                         "    background-color: rgb(5, 153, 44);\n"
                                                         "}\n"
                                                         "MyButton { \n"
                                                         "color: rgb(255, 255, 255);\n"
        ...
        b_enable_cyclic_torque->setStyleSheet(QString::fromUtf8("MyButton:pressed {\n"
                                                                "    background-color: rgb(5, 153, 44);\n"
                                                                "}\n"
                                                                "MyButton { \n"
                                                                "color: rgb(255, 255, 255);\n"
        ...
        b_clear_fault->setStyleSheet(QString::fromUtf8("MyButton:pressed {\n"
                                                         "    background-color: rgb(5, 153, 44);\n"
                                                         "}\n"
                                                         "MyButton { \n"
                                                         "color: rgb(255, 255, 255);\n"
        ...
        b_init_ecat->setStyleSheet(QString::fromUtf8("MyButton:pressed {\n"
                                                     "    background-color: rgb(5, 153, 44);\n"
                                                     "}\n"
                                                     "MyButton { \n"
                                                     "color: rgb(255, 255, 255);\n"
        ...
        b_reinit_ecat->setStyleSheet(QString::fromUtf8("MyButton:pressed {\n"
                                                       "    background-color: rgb(5, 153, 44);\n"
                                                       "}\n"
                                                       "MyButton { \n"
                                                       "color: rgb(255, 255, 255);\n"
        ...
        b_enable_drives->setStyleSheet(QString::fromUtf8("MyButton:pressed {\n"
                                                         "    background-color: rgb(5, 153, 44);\n"
                                                         "}\n"
                                                         "MyButton { \n"
                                                         "color: rgb(255, 255, 255);\n"
        ...
        b_disable_drives->setStyleSheet(QString::fromUtf8("MyButton:pressed {\n"
                                                          "    background-color: rgb(5, 153, 44);\n"
                                                          "}\n"
                                                          "MyButton { \n"
                                                          "color: rgb(255, 255, 255);\n"
        ...
        b_enter_cyclic_pdo->setStyleSheet(QString::fromUtf8("MyButton:pressed {\n"
                                                            "    background-color: rgb(5, 153, 44);\n"
                                                            "}\n"
                                                            "MyButton { \n"
                                                            "color: rgb(255, 255, 255);\n"
        ...
        b_stop_cyclic_pdo->setStyleSheet(QString::fromUtf8("MyButton:pressed {\n"
                                                           "    background-color: rgb(5, 153, 44);\n"
                                                           "}\n"
                                                           "MyButton { \n"
                                                           "color: rgb(255, 255, 255);\n"
        ...
        b_emergency_mode->setStyleSheet(QString::fromUtf8("MyButton:pressed {\n"
        ...
        ls_enter_target_vals->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);\n"
                                                              "selection-background-color: rgb(238, 238, 236);\n"
        ...
        for(int i=0 ; i < NUM_OF_SERVO_DRIVERS;i++){
            ...
            b_send[i]->setStyleSheet(QString::fromUtf8("MyButton:pressed {\n"
                                                       "    background-color: rgb(5, 153, 44);\n"
                                                       "}\n"
                                                       "MyButton { \n"
                                                       "color: rgb(255, 255, 255);\n"
        ...
        for(int i=0 ; i < NUM_OF_SERVO_DRIVERS;i++){
            ...
            b_stop[i]->setStyleSheet(QString::fromUtf8("MyButton:pressed {\n"
                                                       "background-color: rgb(193, 5, 10);\n"
                                                       "}\n"
                                                       "MyButton { \n"
                                                       "color: rgb(255, 255, 255);\n"
        ...
        for(int i=0 ; i < NUM_OF_SERVO_DRIVERS;i++){
            ...
            b_enable[i]->setStyleSheet(QString::fromUtf8("MyButton:pressed {\n"
                                                       "    background-color: rgb(5, 153, 44);\n"
                                                       "}\n"
                                                       "MyButton { \n"
                                                       "color: rgb(255, 255, 255);\n"
        ...
        for(int i=0 ; i < NUM_OF_SERVO_DRIVERS;i++){
            ...
            b_disable[i]->setStyleSheet(QString::fromUtf8("MyButton:pressed {\n"
        ...
        for(int i=0 ; i < NUM_OF_SERVO_DRIVERS;i++){
            ...
            b_vel[i]->setStyleSheet(QString::fromUtf8("MyButton:pressed {\n"
                                                       "    background-color: rgb(5, 153, 44);\n"
                                                       "}\n"
                                                      "MyButton:checked {\n"
                                                      "    background-color: rgb(5, 153, 44);\n"
...
//                                                       "color: rgb(255, 255, 255);\n"
        ...
        for(int i=0 ; i < NUM_OF_SERVO_DRIVERS;i++){
            ...
            b_cyclic_vel[i]->setStyleSheet(QString::fromUtf8("MyButton:pressed {\n"
                                                       "    background-color: rgb(5, 153, 44);\n"
                                                       "}\n"
                                                       "MyButton { \n"
//                                                       "color: rgb(255, 255, 255);\n"
//                                                       "background-color: rgb(252, 119, 3);\n"
        ...
        for(int i=0 ; i < NUM_OF_SERVO_DRIVERS;i++){
            ...
            b_pos[i]->setStyleSheet(QString::fromUtf8("MyButton:pressed {\n"
                                                       "    background-color: rgb(5, 153, 44);\n"
                                                       "}\n"
                                                       "MyButton { \n"
//                                                       "color: rgb(255, 255, 255);\n"
//                                                       "background-color: rgb(252, 119, 3);\n"
        ...
        for(int i=0 ; i < NUM_OF_SERVO_DRIVERS;i++){
            ...
            b_cyclic_pos[i]->setStyleSheet(QString::fromUtf8("MyButton:pressed {\n"
                                                       "    background-color: rgb(5, 153, 44);\n"
                                                       "}\n"
                                                       "MyButton { \n"
//                                                       "color: rgb(255, 255, 255);\n"
//                                                       "background-color: rgb(252, 119, 3);\n"
        ...
        for(int i=0 ; i < NUM_OF_SERVO_DRIVERS;i++){
            ...
            b_tor[i]->setStyleSheet(QString::fromUtf8("MyButton:pressed {\n"
                                                       "    background-color: rgb(5, 153, 44);\n"
                                                       "}\n"
                                                       "MyButton { \n"
//                                                       "color: rgb(255, 255, 255);\n"
//                                                       "background-color: rgb(252, 119, 3);\n"
        ...
        for(int i=0 ; i < NUM_OF_SERVO_DRIVERS;i++){
            ...
            b_cyclic_tor[i]->setStyleSheet(QString::fromUtf8("MyButton:pressed {\n"
                                                       "    background-color: rgb(5, 153, 44);\n"
                                                       "}\n"
                                                       "MyButton { \n"
//                                                       "color: rgb(255, 255, 255);\n"
//                                                       "background-color: rgb(252, 119, 3);\n"
        ...
        for(int i=0; i < NUM_OF_SERVO_DRIVERS;i++){
            ...
            lb_target_pos[i]->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);\n"
                                                              "selection-background-color: rgb(238, 238, 236);\n"
                                                              "selection-color: rgb(238, 238, 236);\n"
        ...
        for(int i = 0; i < NUM_OF_SERVO_DRIVERS; i++){
            ...
            label_motor[i]->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);\n"
                                                            "selection-background-color: rgb(238, 238, 236);\n"
                                                            "selection-color: rgb(238, 238, 236);\n"
                                                            "background-color:  rgb(255, 255, 255);\n"
                                                            "alternate-background-color: rgb(0, 0, 0);\n"
        ...
        status_bar_gridLayout->addWidget(lb_com_status, 7, 1, 1, 2*NUM_OF_SERVO_DRIVERS);
        ...
        lb_motor_error_code->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);\n"
                                                       "selection-background-color: rgb(238, 238, 236);\n"
                                                       "selection-color: rgb(238, 238, 236);\n"
                                                       "background-color:  rgb(255, 255, 255);\n"
                                                       "alternate-background-color: rgb(0, 0, 0);\n"
        ...
        status_bar_gridLayout->addWidget(lb_motor_error_code, 9, 1, 1, 2*NUM_OF_SERVO_DRIVERS);
        ...
        for(int i = 0 ; i < NUM_OF_SERVO_DRIVERS; i++){
            ...
            lb_status_word[i]->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);\n"
                                                               "selection-background-color: rgb(238, 238, 236);\n"
                                                               "selection-color: rgb(238, 238, 236);\n"
                                                               "background-color:  rgb(255, 255, 255);\n"
                                                               "alternate-background-color: rgb(0, 0, 0);\n"
        ...
        for(int i=0; i < NUM_OF_SERVO_DRIVERS;i++){
            ...
            lb_actual_tor[i]->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);\n"
                                                              "selection-background-color: rgb(238, 238, 236);\n"
                                                              "selection-color: rgb(238, 238, 236);\n"
                                                              "background-color:  rgb(255, 255, 255);\n"
                                                              "alternate-background-color: rgb(0, 0, 0);\n"
        ...
        for(int i=0 ; i < NUM_OF_SERVO_DRIVERS; i++){
            ...
            lb_op_mode[i]->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);\n"
                                                           "selection-background-color: rgb(238, 238, 236);\n"
                                                           "selection-color: rgb(238, 238, 236);\n"
                                                           "background-color:  rgb(255, 255, 255);\n"
                                                           "alternate-background-color: rgb(0, 0, 0);\n"
        ...
        for(int i = 0 ; i < NUM_OF_SERVO_DRIVERS; i++){
            ...
            lb_target_vel[i]->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);\n"
                                                              "selection-background-color: rgb(238, 238, 236);\n"
                                                              "selection-color: rgb(238, 238, 236);\n"
                                                              "background-color:  rgb(255, 255, 255);\n"
                                                              "alternate-background-color: rgb(0, 0, 0);\n"
        ...
        lb_safety_state->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);\n"
                                                             "selection-background-color: rgb(238, 238, 236);\n"
                                                             "selection-color: rgb(238, 238, 236);\n"
                                                             "background-color:  rgb(255, 255, 255);\n"
                                                             "alternate-background-color: rgb(0, 0, 0);\n"
        ...
        status_bar_gridLayout->addWidget(lb_safety_state, 8, 1, 1, 2*NUM_OF_SERVO_DRIVERS);
        ...
        status_bar_gridLayout->addWidget(ls_ecat_status_bar, 6, 0, 1, 2*NUM_OF_SERVO_DRIVERS+1);
        ...
        for(int i = 0 ; i < NUM_OF_SERVO_DRIVERS ; i++){
            ...
            lb_target_tor[i]->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);\n"
                                                              "selection-background-color: rgb(238, 238, 236);\n"
                                                              "selection-color: rgb(238, 238, 236);\n"
                                                              "background-color:  rgb(255, 255, 255);\n"
                                                              "alternate-background-color: rgb(0, 0, 0);\n"
        ...
        for(int i = 0; i < NUM_OF_SERVO_DRIVERS;i++){
            ...
            lb_actual_pos[i]->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);\n"
                                                              "selection-background-color: rgb(238, 238, 236);\n"
                                                              "selection-color: rgb(238, 238, 236);\n"
                                                              "background-color:  rgb(255, 255, 255);\n"
                                                              "alternate-background-color: rgb(0, 0, 0);\n"
        ...
        for(int i = 0 ; i < NUM_OF_SERVO_DRIVERS; i++){
            ...
            lb_control_word[i]->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);\n"
                                                                "selection-background-color: rgb(238, 238, 236);\n"
                                                                "selection-color: rgb(238, 238, 236);\n"
                                                                "background-color:  rgb(255, 255, 255);\n"
                                                                "alternate-background-color: rgb(0, 0, 0);\n"
        ...
        ls_safety_state->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);\n"
                                                             "selection-background-color: rgb(238, 238, 236);\n"
                                                             "selection-color: rgb(238, 238, 236);\n"
                                                             "background-color:  rgb(255, 255, 255);\n"
                                                             "alternate-background-color: rgb(0, 0, 0);\n"
        ...
        ls_motor_error_code->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);\n"
                                                       "selection-background-color: rgb(238, 238, 236);\n"
                                                       "selection-color: rgb(238, 238, 236);\n"
                                                       "background-color:  rgb(255, 255, 255);\n"
                                                       "alternate-background-color: rgb(0, 0, 0);\n"
        ...
        for(int i =0 ; i < NUM_OF_SERVO_DRIVERS;i++){
            ...
            lb_actual_vel[i]->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);\n"
                                                              "selection-background-color: rgb(238, 238, 236);\n"
                                                              "selection-color: rgb(238, 238, 236);\n"
                                                              "background-color:  rgb(255, 255, 255);\n"
                                                              "alternate-background-color: rgb(0, 0, 0);\n"
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        b_enable_cylic_vel->setText(QApplication::translate("MainWindow", "Enable Cyclic\n"
                                                                          "Velocity Mode All",
                                                            nullptr));
        b_enable_torque->setText(QApplication::translate("MainWindow", "Enable\n"
                                                                       "Torque Mode All",
                                                         nullptr));

        b_enable_cyclic_torque->setText(QApplication::translate("MainWindow", "Enable Cyclic\n"
                                                                              "Torque Mode All",
                                                                nullptr));
        ...
        b_enable_pos->setText(QApplication::translate("MainWindow", "Enable \n"
                                                                    " Position Mode All",
                                                      nullptr));
        b_clear_fault->setText(QApplication::translate("MainWindow", "Clear\n"
                                                                           "Faults All",
                                                             nullptr));
        ...
        b_reinit_ecat->setText(QApplication::translate("MainWindow", "Restart \n"
                                                                     "EtherCAT Master",
                                                       nullptr));
        b_enable_drives->setText(QApplication::translate("MainWindow", "Enable All\n"
                                                                       "Drives",
                                                         nullptr));
        b_disable_drives->setText(QApplication::translate("MainWindow", "Disable All\n"
                                                                        " Drives",
                                                          nullptr));
        ...
        ls_enter_target_vals->setText(QApplication::translate("MainWindow", "Enter Target Value (Velocity, Torque,Position)", nullptr));
