...
TimingNode::TimingNode() : Node("timing_node")
{
  auto qos = rclcpp::QoS(rclcpp::KeepLast(1));
  qos.best_effort();
  received_data_sub_ = this->create_subscription<ecat_msgs::msg::DataReceived>(
      "Slave_Feedback", qos, std::bind(&TimingNode::HandleReceivedDataCallback, this, std::placeholders::_1));
